package com.example.MarineSpecies.MarineSpeciesManager.Controller;
...
import com.example.MarineSpecies.MarineSpeciesManager.Entity.*;
import com.example.MarineSpecies.MarineSpeciesManager.Entity.DTO.MarineSpeciesDTO;
import com.example.MarineSpecies.MarineSpeciesManager.Entity.DTO.TaxonomyQuery;
import com.example.MarineSpecies.MarineSpeciesManager.Mapper.*;
...
//            @SessionAttribute("signedIn") SignedIn signedIn,
    ...
    public MyResponse<Integer> editImage(
        ...
        for(String url:marineSpeciesDTO.getImageList()){
            ...
            wrapper
                    .eq(Image::getUrl, url)
                    .eq(Image::getMarineSpeciesId,marineSpeciesDTO.getGenusName());
